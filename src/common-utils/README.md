...
```json
"features": {
    "ghcr.io/doytsujin/features/common-utils:2": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/doytsujin/features/blob/main/src/common-utils/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
