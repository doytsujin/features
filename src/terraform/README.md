...
```json
"features": {
    "ghcr.io/doytsujin/features/terraform:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/doytsujin/features/blob/main/src/terraform/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
